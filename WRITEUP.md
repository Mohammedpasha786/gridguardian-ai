...
1. **Climate Risk Agent** looks up heatwave probability, flood risk,
...
2. **Demand Forecast Agent** pulls an hourly weather forecast and runs it
...
3. **Dispatch Optimizer Agent** reads the real-time battery/solar/load
...
4. **Resilience Advisor Agent** has *no tools at all*. It only reads the
